...
function App() {
  ...
  return (
    <div className="min-h-screen bg-paper font-sans text-ink">
      ...
      {/* Floating Research Button - Simple */}
      {showResearchBtn && (
        <button
          onClick={() => setShowResearch(true)}
          className="fixed bottom-6 right-6 z-40 bg-white border border-border shadow-soft rounded-full p-3 hover:shadow-soft-hover transition-all"
